...
def test_no_overlap_carries_nothing() -> None:
    """
    Scenario: no overlap carries nothing.
...
def test_negative_overlap_carries_nothing() -> None:
    """
    Scenario: negative overlap carries nothing.
    Slice: 45 — GWT-on-touch (module theme separation)
    """
    ### Given
    ### When
...
def test_empty_group_carries_nothing() -> None:
    """
    Scenario: empty group carries nothing.
    Slice: 45 — GWT-on-touch (module theme separation)
    """
    ### Given
    ### When
...
def test_carries_last_sentence_even_when_over_budget() -> None:
    """
    Scenario: carries last sentence even when over budget.
    Slice: 45 — GWT-on-touch (module theme separation)
    """
    ### Given
    ### When
...
def test_carries_multiple_trailing_sentences_within_budget() -> None:
    """
    Scenario: carries multiple trailing sentences within budget.
    Slice: 45 — GWT-on-touch (module theme separation)
    """
    ### Given
    ### When
...
def test_overlap_preserves_sentence_order() -> None:
    """
    Scenario: overlap preserves sentence order.
    Slice: 45 — GWT-on-touch (module theme separation)
    """
    ### Given
    ### When
...
def test_overlap_exceeds_chunk_size_emits_warning() -> None:
    """
    Scenario: overlap exceeds chunk size emits warning.
    Slice: 45 — GWT-on-touch (module theme separation)
    """
    ### Given
    ### When
...
def test_semantic_dispatch_passes_overlap_to_chunk_semantic() -> None:
    """
    Scenario: semantic dispatch passes overlap to chunk semantic.
    Slice: 45 — GWT-on-touch (module theme separation)
    """
    ### Given
    ### When
...
def test_semantic_dispatch_overlap_zero_vs_nonzero() -> None:
    """
    Scenario: semantic dispatch overlap zero vs nonzero.
    Slice: 45 — GWT-on-touch (module theme separation)
