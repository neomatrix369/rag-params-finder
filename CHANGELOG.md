...
- **Module theme map** (Slice 44 Should §3) — Behavior | Feature | Function taxonomy and ranked folder-separation proposals for five flat hotspots ([module-theme-map.md](docs/contributor-guide/module-theme-map.md)); filesystem moves deferred to [SLICE-45](docs/plan/slices/SLICE-45-MODULE-THEME-SEPARATION.md) (**PROPOSED**). Frontend coverage floor in gates remains **PROPOSED** (Slice 44 Must).
