...
- **Frontend coverage gate** (Slice 44 Must) — `quality-gates.sh` / `pre-push-gates.sh` run `npm run test:coverage`; CI frontend runs `test:ci`; Vitest v8 thresholds (lines ≥64%) (**VERIFIED**).
