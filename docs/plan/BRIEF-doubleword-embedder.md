...
> **Decisions:** [DECISIONS #188–#207](DECISIONS.md). **Reference implementation:** `playgroup_202602_docextract` (`llm_doubleword.py`, `extractor.py::_run_all_doubleword`, `DW_FB.md`, `docs/doubleword-platform-knowledge.md`).
