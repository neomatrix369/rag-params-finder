...
- **DoubleWord embedder brief** (`docs/plan/BRIEF-doubleword-embedder.md`, 2026-09-24): owner plan titled "SLICE-32" → renumbered **48A–48D** (32 taken by the Storage Protocol track); **batch-first** per the docextract reference project: mixed-provider axis + batch provider + detached watcher → cost + hardening → MRL/instruction axes → realtime (Could) (DECISIONS #188–#204)
