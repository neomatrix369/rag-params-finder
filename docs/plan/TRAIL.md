...
| 44 | [../plan/slices/SLICE-44-FRONTEND-COVERAGE-GATE.md](../plan/slices/SLICE-44-FRONTEND-COVERAGE-GATE.md) | Frontend coverage + gate summary + structure taxonomy Should (theme map; moves → 45); review remediations #137; **Residual §4** Nightly Stryker (#163) | Should | ✅ COMPLETE (+ residual) | none (Vitest harness) | — | ~3 min | 2026-07-28 |
