...
| 39 | [../plan/slices/SLICE-39-DEMO-READY-DASHBOARD-POLISH.md](../plan/slices/SLICE-39-DEMO-READY-DASHBOARD-POLISH.md) | Demo-ready dashboard polish — list-to-detail visual journey | Should | 📋 PLANNED | none | — | ~3 min | 2026-07-18 |
| 41 | [../plan/slices/SLICE-41-DOCS-PLAN-SLICES-SSOT.md](../plan/slices/SLICE-41-DOCS-PLAN-SLICES-SSOT.md) | Documentation plan/slices SSOT alignment | Should | 📋 PLANNED | none | — | ~1 h | 2026-07-20 |

**Execution order**: 21 → 25 → 25B → 29 (done) → **39** *(≤2 h demo interrupt)* → **32 → 33 → 34 → 35 → 36 → 37 → 38** → **22** → 28*(external)* → 31 → 30 → 16 → 11 → 23 → 10. Slice 41 is docs housekeeping and can run independently of this sequence.
