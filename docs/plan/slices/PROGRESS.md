...
| 34 — Supabase dense retrieval | ✅ COMPLETE | ~3–4 h | pgvector dense + mandatory embedding_model filter; Atlas-scale scores; `hnsw.iterative_scan=strict_order` protects top-k recall; 19 live tests; 4/4-run sweep smoke green — [`SLICE-34-POSTGRES-DENSE-RETRIEVAL.md`](SLICE-34-POSTGRES-DENSE-RETRIEVAL.md) |
