...
|------|-------|----------|-----|
| 2026-07-26 | 37 | sync-docs (post hosted smoke): HANDOFF/PROGRESS/agent guides + CHANGELOG claim `SUPABASE_URI` alias + live `postgres-cloud` VERIFIED; SUPERSEDE Slice 37 Won't URI-alias row and Slice 43 “no SUPABASE_URI” notes | Hosted smoke `49c23d41-…` + DECISIONS #107 made “documented skip” / “no SUPABASE_URI” operator-facing claims false |
