...
| 41A — Bayesian Search: Simple Functional | 📋 PLANNED | ~2.5 h | Bayesian TPE sweep over chunking size/overlap via new `execution.search_strategy` and Optuna experiment docs |
