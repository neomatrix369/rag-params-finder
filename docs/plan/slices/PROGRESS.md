...
| Date | Item | Outcome |
|------|------|---------|
| 2026-08-06 | Nightly CI security fixes (slice/22-sie-scooter) | Three Nightly jobs failing since 2026-08-03: Meterian SCA (`aiohttp` CVE-2026-69244 HIGH + CVE-2026-59881/CVE-2026-69243 MEDIUM; `cryptography` CVE-2026-69247 HIGH), Trivy container scan (same), frontend dependency audit (`brace-expansion` GHSA-rgw5-rvv9-x895 HIGH — previous override 5.0.8 still in vuln range; `qs` GHSA-q8mj-m7cp-5q26 MODERATE). Fixed: `uv lock --upgrade-package aiohttp cryptography` → 3.14.3 / 50.0.0; `package.json` override bumped to 5.0.9 + `qs` 6.15.3 added. Quality gates (344 pytest + 261 vitest + pre-push) **VERIFIED** green locally. Will resolve Nightly on merge to main. |
